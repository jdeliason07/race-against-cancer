      ...
      <div className="mx-auto max-w-3xl px-6 py-20 space-y-12">
        ...
        <section>
          ...
          <div className="space-y-4 font-body text-base leading-relaxed text-ash">
            ...
            <p><strong className="text-ink">Registration information:</strong> When you register for the race, we collect your name, email address, phone number, date of birth, and emergency contact details, along with your race choice, bandana colour, and a record that you accepted the waiver — including when, and which version. If the athlete is under 18 on race day, we also collect the name of the parent or legal guardian who accepts the waiver on their behalf. If you register a group, we collect your contact details and the number of athletes; each athlete&rsquo;s own details are collected at check-in on race morning. This information is necessary to process your registration.</p>
            <p><strong className="text-ink">Referral information:</strong> Registration includes an optional &ldquo;Who referred you?&rdquo; box. If you enter someone&rsquo;s name, we store it against your registration so we can send that person a thank-you reward. This means you may be giving us the name of another person &mdash; we use it only to identify who to thank, we do not contact them using it, and either of you can ask us to remove it.</p>
        ...
        <section>
          ...
          <ul className="space-y-3 font-body text-base text-ash">
            {[
              ...
              'To identify and thank whoever referred you, if you named someone during registration.',
        ...
        <section>
          ...
          <ul className="mt-4 space-y-3 font-body text-base text-ash">
            {[
              ...
              'Sender (sender.net) — our email provider. We copy your name, email address, and phone number there so we can send you race announcements and updates. Every email we send includes an unsubscribe link, and unsubscribing there stops all bulk email from us.',
